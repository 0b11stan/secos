...
void userland()
{
  ...
  //asm volatile ("mov %eax, %cr0"); // unallowed instruction from userland
  
  //asm volatile ("int $48"::"a"(0x1337));
  //char* tmp = "Bonjour du noyau";

  asm volatile ("int $48"::"S"(0x2000));
